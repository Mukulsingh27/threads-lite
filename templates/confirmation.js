															...
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-top:20px;">
																	<div style="color:#393d47;direction:ltr;font-family:'Merriweather', 'Georgia', serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:center;mso-line-height-alt:24px;">
																		<p style="margin: 0;">We're excited to have you on board! Before we get started, we need you to confirm your identity. This ensures that only you'll be able to access your account and receive all our offers and updates. To confirm your identity, kindly click the 'Confirm' button below. Thank you for choosing us, and we eagerly anticipate serving you!"</p>
																	</div>
																</td>
															</tr>
														</table>
